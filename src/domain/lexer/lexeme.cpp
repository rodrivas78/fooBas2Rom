...
const set<string> keywords = {
    "?",         "ABS",       "ADJUST",       "AND",       "ASC",
    "ATN",       "BASE",      "BP",         "BIN$",      "BLOAD",
    "BSAVE",     "CALL",      "CDBL",         "CHR$",      "CINT",
    "CI",    "CLEAR",     "CLRSCR",       "CLRKEY",    "CL",
    "CLOAD",     "CLOSE",     "CMD",          "CO", "CR",
    "COPY",      "COS",       "CSAVE",        "CSNG",      "CSRLIN",
    "DT",      "DATE",      "DEF",          "DEFDBL",    "DI",
    "DEFSNG",    "DEFSTR",    "DM",          "DISSCR",    "DW",
    "EL",      "ENASCR",    "EN",          "EOF",       "EQV",
    "ERASE",     "ERROR",     "EXP",          "FILES",     "FILE",
    "FIX",       "FLIP",      "FN",           "FONT",      "FO",
    "FROM",      "FRE",       "GET",          "GS",     "GT",
    "HEAP",      "HEX$",      "IDATA",        "IF",        "IMP",
    "INCLUDE",   "INKEY",     "INKEY$",       "INP",       "IP",
    "INPUT$",    "INSTR",     "INT",          "IN",  "IPEEK",
    "IPOKE",     "IREAD",     "IRESTORE",     "KANJI",     "KEY",
    "KEYCLKOFF", "LEFT$",     "LEN",          "LET",       "LN",
    "LLIST",     "LOAD",      "LC",       "LOG",       "LPOS",
    "LPRINT",    "MAKER",     "MAXFILES",     "MERGE",     "MID$",
    "MOD",       "MOTOR",     "MSX",          "MUTE",      "NEW",
    "NX",      "NOT",       "NTSC",         "OCT$",      "OFF",
    "ON",        "OPEN",      "OR",           "OUT",       "PAD",
    "PAGE",      "PAINT",     "PASTE",        "PATTERN",   "PAUSE",
    "PDL",       "PEEK",      "PL",         "PLYLOAD",   "PLYLOOP",
    "PLYMUTE",   "PLYPLAY",   "PLYREPLAY",    "PLYSOUND",  "PLYSTATUS",
    "PLYSONG",   "POINT",     "PK",         "POS",       "PRESET",
    "PRINT",     "PROMPT",    "PSG",          "PS",      "PT3LOAD",
    "PT3LOOP",   "PT3MUTE",   "PT3PLAY",      "PT3REPLAY", "PU",
    "RN", "RAMTORAM",  "RAMTOVRAM",    "RD",      "REDIM",
    "REM",       "RESOURCE",  "RESOURCESIZE", "RS",   "RM",
    "RT",    "RIGHT$",    "RND",          "ROTATE",    "RSCTORAM",
    "RUN",       "RUNASM",    "RUNBAS",       "SAVE",      "SN",
    "SCROLL",    "SEED",      "SET",          "SETFNT",    "SGN",
    "SHL",       "SHR",       "SIN",          "SD",     "SPACE$",
    "SPC",       "SP",    "S$",      "SQR",       "STEP",
    "STICK",     "STOP",      "STR$",         "STRING$",   "SG",
    "SWAP",      "TAB",       "TAN",          "TAND",      "TEXT",
    "TH",      "TILE",      "TILES",        "TM",      "TITLE",
    "TO",        "TOR",       "TPRESET",      "TPSET",     "TURBO",
    "TXOR",      "UPDFNTCLR", "USR",          "USING",     "USING$",
    "VAL",       "VARPTR",    "VDP",          "VIDEO",     "VPEEK",
    "VP",     "VRAMTORAM", "WAIT",         "WIDTH",     "WRTCHR",
...
const set<string> functions = {
    ...
    "SGN",    "SIN",   "SPACE$",   "SPC",          "S$",   "SNG",
    "SQR",    "STICK", "STR$",     "STRING$",      "SG",     "TAB",
    "TAN",    "TILE",  "TM",     "TURBO",        "USR",       "USR0",
