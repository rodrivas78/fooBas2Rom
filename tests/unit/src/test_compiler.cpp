...
TEST_SUITE("CompilerCmdHandlerFactory") {
  ...
  TEST_CASE("All CMD handlers are registered") {
    ...
    std::vector<std::string> keywords = {
        ...
        "DISSCR",    "ENASCR",    "KEYCLKOFF", "MUTE",      "PL",
        "DW",      "CLIP",      "PT3LOAD",   "PT3PLAY",   "PT3MUTE",
...
TEST_SUITE("CompilerStatementStrategyFactory") {
  TEST_CASE("All strategies are registered") {
    ...
    std::vector<std::string> keywords = {
        ...
        "CLEAR",    "DEF",       "DI",   "DEFSNG", "DEFDBL", "DEFSTR",
        "DEFUSR",   "CL",       "BP",     "LET",    "TM",   "DM",
        "REDIM",    "RN",

        "EN",      "GT",      "GS",    "RT", "IF",     "FO",
        "NX",     "ON",        "IN", "STOP",

        "PRINT",    "IP",     "SD",    "OUT",    "PK",   "VP",
        "IPOKE",    "DT",      "IDATA",    "RD",   "IREAD",  "RS",
        "IRESTORE", "RM",    "WAIT",     "SWAP",   "CALL",   "CMD",
        "MAXFILES", "OPEN",      "OPEN_GRP", "CLOSE",  "BLOAD",

        "PL",     "DW",      "LC",   "SN", "WIDTH",  "CR",
        "PS",     "PRESET",    "LN",     "PAINT",  "CI", "COPY",
...
TEST_SUITE("CompilerCmdHandlers") {
  TEST_CASE("All CMD instruction handlers execute successfully") {
    ...
    const CmdCase cases[] = {
        ...
        {"PL", "PL", {numLex("1")}, true, false, false, false},
        {"DW", "DW", {numLex("1")}, true, false, false, false},
        ...
        {"RS", "RS", {numLex("1")}, true, false, false, false},
...
TEST_SUITE("CompilerFunctionStrategies") {
  TEST_CASE("All function strategies execute successfully") {
    ...
    const FuncCase cases[] = {
        ...
        {"TM", "TM", 0, {}, false, {}, Lexeme::subtype_numeric},
